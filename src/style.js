const styles = {
    ...
    body3: "font-pretendard font-light text-[1.25rem] text-grey tracking-tight w-full",
    paragraph: "font-pretendard font-light tracking-tight text-darkblue text-[1.15rem] leading-normal",
    paragraph3: "font-pretendard font-light tracking-tight text-grey text-[1.15rem] leading-normal",
    paragraph2: "font-pretendard font-regular tracking-tight text-black text-[1.15rem] leading-normal",
